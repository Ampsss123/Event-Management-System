            ...
            <div class="col-md-6">
              ...
              <div class="card bg-gradient-info card-img-holder text-white"style="height: 130px;">
                <div class="card-body" >
                  ...
                  <?php 
                  $sql = "SELECT COUNT(ID) as totalNewBookings FROM tblbooking WHERE Status IS NULL";
                  $query = $dbh->prepare($sql);
                  $query->execute();
                  $result = $query->fetch(PDO::FETCH_ASSOC);
                  $totalNewBookings = $result['totalNewBookings'];                  
                  ?>
                  <h2 class="mb-5"><?php echo htmlentities($totalNewBookings);?></h2>
                </div>
              </div>
            </div>
            ...
            <div class="col-md-6 stretch-card grid-margin">
              <div class="card bg-gradient-warning card-img-holder text-white"style="height: 130px;">
                <div class="card-body">
                  ...
                  <?php 
                  $sql = "SELECT (SELECT COUNT(ID) FROM tblbooking WHERE Status = 'Approved') as totalApprovedBookings";
                  $query = $dbh->prepare($sql);
                  $query->execute();
                  $result = $query->fetch(PDO::FETCH_ASSOC);
                  $totalApprovedBookings = $result['totalApprovedBookings'];
                  
                  ?> 
                  <h2 class="mb-5"><?php echo htmlentities($totalApprovedBookings);?></h2>
                </div>
              </div>
            </div>
            <div class="col-md-6 stretch-card grid-margin">
              <div class="card bg-gradient-primary  card-img-holder text-white"style="height: 130px;">
                <div class="card-body">
                  ...
                  <?php 
                  $sql = "SELECT (SELECT COUNT(ID) FROM tblbooking WHERE Status = 'Cancelled') as totalCancelledBookings";
                  $query = $dbh->prepare($sql);
                  $query->execute();
                  $result = $query->fetch(PDO::FETCH_ASSOC);
                  $totalCancelledBookings = $result['totalCancelledBookings'];                  
                  ?>
                  <h2 class="mb-5"><?php echo htmlentities($totalCancelledBookings);?></h2>
                </div>
              </div>
            </div>
            <div class="col-md-6 stretch-card grid-margin">
              <div class="card bg-gradient-success card-img-holder text-white"style="height: 130px;">
                <div class="card-body">
                  ...
                  <?php 
                  $sql ="SELECT COUNT(ID) as totalServices FROM tblservice";
                  $query = $dbh->prepare($sql);
                  $query->execute();
                  $result = $query->fetch(PDO::FETCH_ASSOC);
                  $totalserv = $result['totalServices'];
                  ?>
